...
public class PraktikTgBotApplication implements CommandLineRunner {
	...
	@Autowired
	private AllPerformer allPerformer;



	public static void main(String[] args) {
		SpringApplication.run(PraktikTgBotApplication.class, args);
	}
